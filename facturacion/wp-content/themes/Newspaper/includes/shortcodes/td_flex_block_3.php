...
class td_flex_block_3 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        $res_ctx->load_settings_raw( 'show_author1', $res_ctx->get_shortcode_att('show_author1') );
        $res_ctx->load_settings_raw( 'show_author2', $res_ctx->get_shortcode_att('show_author2') );
        $res_ctx->load_settings_raw( 'show_date1', $res_ctx->get_shortcode_att('show_date1') );
        $res_ctx->load_settings_raw( 'show_date2', $res_ctx->get_shortcode_att('show_date2') );
        $res_ctx->load_settings_raw( 'show_com1', $res_ctx->get_shortcode_att('show_com1') );
        $res_ctx->load_settings_raw( 'show_com2', $res_ctx->get_shortcode_att('show_com2') );
