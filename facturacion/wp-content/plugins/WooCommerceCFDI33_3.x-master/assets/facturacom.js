    ...
    $.post(myAjax.ajaxurl, data, function(response) {
      ...
      */
      ...
      if(response.metadata != null && response.metadata.code == 101){
        ...
        $('#btn-success-pdf').stop().show().attr('href','http://devfactura.in/api/publica/cfdi33/'+response.metadata.uid+'/pdf');
        $('#btn-success-xml').stop().show().attr('href','http://devfactura.in/api/publica/cfdi33/'+response.metadata.uid+'/xml');
        $('#step-one').stop().hide();
  ...
  $('#step-three-button-next').click(function(e){
    ...
    $.post(myAjax.ajaxurl, data, function(response){
      ...
      if(response.invoice.response == 'success'){
        ...
        $('#btn-success-pdf').stop().show().attr('href','http://devfactura.in/api/publica/cfdi33/'+response.invoice.invoice_uid+'/pdf');
        $('#btn-success-xml').stop().show().attr('href','http://devfactura.in/api/publica/cfdi33/'+response.invoice.invoice_uid+'/xml');
      }else{
