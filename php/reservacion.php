<?php
    ...
    $fechaLlegada = $_POST["inFechaLlegada"];
    $horaLlegada = $_POST["inHoraLlegada"];
    $estancia = $_POST["inEstancia"];
    $fechaSalida = $_POST["inFechaSalida"];
    ...
    $to = "reservaciones@macparkk.mx";
    $subject = "Nueva reservación para " . $r_email;
    ...
    $message = '
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body style="margin:0 auto;">
                ...
                <tr>
                    <td>
                        <h1>Hay una nueva Reservación. </h1>
                    </td>
                </tr>
                <!-- 3 columnas -->
                <tr>
                    <td align="center" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;" >
                        <table class="table table-dark">
                            ...
                            <tbody>
                                <tr>
                                    <td>' . $fechaLlegada . " - " . $horaLlegada . '</td>
    ...
    /* ----- Email response for client ----- */

    $to = $r_email;
    $subject = "Haz hecho una reservación en MacParkk";
    ...
    <body style="margin:0 auto;">
        ...
        <!-- Contenido -->
            ...
            <tr>
                    <td>
                        <h1> Confirmación de tu resevación.</h1>
                    </td>
                </tr>
                <!-- 3 columnas -->
                <tr>
